...
importScripts(
  "/assets/precache-manifest.3bb6edc2ecd428725ea4dd33415640a5.js"
);
...
workbox.routing.registerRoute(/\/(images|assets|admin-assets)\//, workbox.strategies.networkFirst(), 'GET');
