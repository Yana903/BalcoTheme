...
export { default as DeliveryContainer } from './containers/delivery';
export { default as AboutContainer } from './containers/about';
export { default as NewsContainer } from './containers/news';
