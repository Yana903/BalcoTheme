...
export default class SearchBox extends React.Component {
	...
	render() {
		...
		return React.createElement(
			'div',
			{
				className: `naviigation__search search-box ${this.props.className}${hasFocus ? ' has-focus' : ''}`
			},
			React.createElement('input', {
				...
				style: { fontFamily: 'Poppins', background: '#fff' }
			}),
			React.createElement(
				'button',
				{
				...
				React.createElement(ArrowForwardIcon, { style: { fontSize: 20 } })
			),
